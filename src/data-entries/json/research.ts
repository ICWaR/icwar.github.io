...
[
  ...
  "../../assets/images/Slide/Research/Slide12.jpg",
  "../../assets/images/Slide/Research/Slide13.jpg",
  "../../assets/images/Slide/Research/Slide16.jpg",
  "../../assets/images/Slide/Research/Slide17.jpg"
]
...
export const research_projects=
  {
    "Ongoing":[
      ...
      {
        'Title' : 'Development and application of a stochastic rainfall generator (SRG) to account for unprecedented rainfall events.',
        'Investigators': 'Dr. Rajarshi Das Bhowmik (PI), Prof. D Nagesh Kumar (Co PI)',
        'Sponsor': 'SERB Core Research Grant'
      },
      {
        'Title' : '	Mapping Terrestrial Water Resources from Space',
        'Investigators': 'Dr. Bramha Dutt Vishwakarma (PI); Prof. D Nagesh Kumar (Co PI); Dr. Sharad Chander, SAC-ISRO  (Co PI); Dr. Bhaskar R. Nikam, IIRS-ISRO  (Co PI)',
        'Sponsor': 'SERB'
      },
      {
        'Title' : 'Improving the spatial resolution of GRACE TWS for India using remote sensing datasets and modeling approach',
        'Investigators': 'Dr. Bramha Dutt Vishwakarma (PI)',
        'Sponsor': 'IISc-ISRO STC'
      },
      {
        'Title' : 'Advanced Research in Hydrology and Knowledge Dissemination',
        'Investigators': 'Prof P P Mujumdar (PI); Prof  Nagesh Kumar D (Co PI); Prof  M Sekhar (Co PI); Prof  V V Srinivas (Co PI); Prof  Govindasamy Bala (Co PI); Prof  Venugopal V (Co PI);Prof  Prosenjit Ghosh (Co PI); Dr Ramananda Chakrabarti (Co PI) ',
        'Sponsor': 'MoES'
      },
      {
        'Title' : '	Intelligent water supply network monitoring and control for EQuitable Distribution of Water within Mega city (EQWATER)',
        'Investigators': 'Prof V V Srinivas (PI); Lakshminarayana Rao M P (Co PI); Amrutur Bharadwaj (Co PI); Rajesh Sundaresan (Co PI); Yogesh Simmhan (Co PI); R. Parthasarathy (Co PI); Chiranjib Bhattacharyya (Co PI); P. N. Ravindra (BWSSB) (Co PI)',
        'Sponsor': 'MHRD'
      },
      {
        'Title' : 'Urban Modelling: Development of Multi-sectorial Simulation Lab and Science- Based Decision Support Framework to Address Urban Environmental Issues',
        'Investigators': 'Prof P P Mujumdar (PI); Prof B S Murthy (IIT Madras) (Co PI); Dr G S Srinivasa Reddy (KSNDMC) (Co PI)',
        'Sponsor': 'DST and MeitY (Under National Supercomputing Mission (NSM))'
      },
      {
        'Title' : 'Smart water Solutions in Agriculture: Integration of Sensors, Satellite & ICT tools',
        'Investigators': 'Prof M Sekhar (PI) Rajendra Nath Goswami (Robert Bosch) (Co PI)',
        'Sponsor': 'MHRD'
      },
      {
      ...
      {
        'Title' : 'Estimation of Higher resolution Soil moisture Over UK Combining Active and Passive  Microwave Satellite data',
        'Investigators': 'Prof  M Sekhar (PI)',
        'Sponsor': '	CEH, UK'
      },
      {
        'Title' : 'Hydro Nation International Fellows Programme',
    ...
    "Completed": [
      ...
      {
        'Title': 'Likely Impacts of Climate Change on the Water Resources of Karnataka State',
      ...
      {
        'Title': 'Upscaling Catchment Processes for Sustainable Water Management in Peninsular India (Newton – Bhabha Project) (Collaborative project with Centre for Ecology and Hydrology (CEH), UK; ICWaR is the Indian Lead)',
        'Investigators': 'Prof P P Mujumdar (PI); Prof M Sekhar (Co PI); ATREE (Co PI); ICRISAT (Co PI)',
        'Sponsor': 'MoES'
      },
      {
        'Title': 'Statistical Downscaling for Hydro-climatic projections with CMIP5 Simulations  to Assess Impact of Climate Change',
        'Investigators': 'Prof P P Mujumdar (PI)',
        'Sponsor': 'MoWR'
      },
      {
        'Title': 'Coupled human and Natural systems environment (CHANSE) for water management under uncertainty in the Indo- Gangetic Plain (Newton-Bhabha Project) (Collaborative project with Imperial College London; IIT Bombay is the Lead; ICWaR is partner)',
        'Investigators': 'Prof P P Mujumdar (PI)',
        'Sponsor': 'MoES'
      },
      {
        'Title': 'DST Urban Climate Network Workshop',
        'Investigators': 'Prof P P Mujumdar (PI)',
        'Sponsor': 'DST'
      },
      {
        'Title': 'Design of an Expert System for Flood forecasting and management for the city of Chennai',
        'Investigators': 'Prof P P Mujumdar (PI)',
        'Sponsor': 'PSA'
      },
      {
        'Title': 'Develop a Portal on Downscaled Information for Smart city as a Permanent website for Training Purposes and Organize Monsoon School on Urban Floods using ICT’s',
        'Investigators': 'Prof  P P Mujumdar (PI)',
        'Sponsor': 'UNESCO'
      }
    ],
    "Abbreviations": [
      ...
      {
        'EMPRI': 'Environmental and Policy Research Institute'
      },
      {
      ...
      {
        'MHRD': 'Ministry of Human Resource Developmen'
      },
      {
        'MoES': 'Ministry of Earth Sciences, Govt. of India'
      },
      {
        'MoWR': 'Ministry of Water Resources, Govt. of India'
      },
      {
        'NSM': 'National Supercomputing Mission'
      },
      {
        'PSA': 'Office of Principal Scientific Advisor'
      },
      {
